Arch Linux Arm is a great opeating system, but it lacks community support compared to other operating systems for ARM. Also some programs didn't work because of some package errors or because of the lack of packages, so I decided to fix that!
